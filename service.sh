...
ans=$(curl -s -X POST -H "Content-Type: application/json" -d '{  "app_key": "c185926462994340b327a733cbbfa817",  "app_secret": "a84bebd094f04429bfac104c39cf59e0"}' "https://open.c.163.com/api/v1/token")
